...
class FreightOperation(models.Model):
    ...
    name = fields.Char(string="Name", copy=False, required=True, readonly=True, default=lambda self: _('New'))
    ...
    commercial_invoices_ids = fields.One2many(
        "operation.commercial.invoice", "operation_id", string="Commercial invoices"
    )
    tracking_ids = fields.One2many(
        "operation.tracking", "operation_id", string="Trackings"
    )
    container_ids = fields.One2many("freight.offer.cargaison", "operation_id", string="Package type", copy=False)
    ...
    exp_send_date = fields.Date(string="Estimated Time Departure", help="Expected Send Date")
    act_send_date = fields.Date(string="Actual Time Departure ", help="Actual Send Date")
    exp_rec_date = fields.Date(string="Estimated Time Arrival")
    act_rec_date = fields.Date(string="Actual Time Departure")
    opp_party_id = fields.Many2one("res.partner", string="Party")
    invoice_id = fields.Many2one("account.move", string="Invoice", copy=False)
    bill_id = fields.Many2one("account.move", string="Bill")
    exp_inv_payment = fields.Float(string="Sale Amount", compute="_compute_expected_receivable_payment")
...
class FreightOperationLine(models.Model):
    ...
    container_id = fields.Many2one("freight.container", string="Container", required=False)
    ...
    offer_id = fields.Many2one("freight.offer", string="Operation", copy=False)
...
class OperationService(models.Model):
    ...
    operation_id = fields.Many2one("freight.operation", string="Operation")
    offer_id = fields.Many2one("freight.offer", string="Offer")
...
class OperationCommercialInvoice(models.Model):
    ...
    _description = "Operation commercial invoices"
    ...
    currency_id = fields.Many2one('res.currency', string='Currency', readonly=False,
                                  default=lambda self: self.env.ref('base.main_company').currency_id)
    rate = fields.Float(string="Currency Rate", default=1.00)
    transit_coast = fields.Float(string="Transport cost")
    transit_currency_id = fields.Many2one('res.currency', string='Currency', readonly=False,
                                          default=lambda self: self.env.ref('base.main_company').currency_id)
    transit_rate = fields.Float(string="Currency Rate", default=1.00)
