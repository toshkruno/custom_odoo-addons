...
class Folder(models.Model):
    ...
    category_id = fields.Many2one("freight.category", string="Category", required=False)
    directory_number = fields.Char(string="Directory Reference", required=False)
    closing_date = fields.Date(string="Closing Date Estimated", required=False)
    state = fields.Selection([('open', 'Open'), ('closed', 'Closed')], string="Status", default='open')
    act_credit = fields.Float(string="Actual credit", compute="_compute_credit", required=False, default=0.00)
    act_debit = fields.Float(string="Actual debit", compute="_compute_debit", required=False, default=0.00)
